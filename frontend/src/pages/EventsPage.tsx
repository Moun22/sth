  ...
  return (
    <Stack gap="6">
      <PageHeader
        ...
        techs={[
          { tech: 'redis', suffix: 'SUBSCRIBE offers:new' },
          { tech: 'sse', suffix: '/events/offers' },
          { tech: 'mongo', suffix: 'insertOne (POST /offers)' },
        ]}
        description={
          <>
              ...
              {feed.length === 0 ? (
                ...
                feed.map((item, i) => (
                  <HStack
                    ...
                    borderLeftColor={i === 0 ? 'red.default' : 'red.a4'}
                    bg={i === 0 ? 'red.a2' : 'transparent'}
                    gap="3"
                  >
                    ...
                    <Stack gap="0.5" flex="1">
                      <HStack gap="2">
                        ...
                        <Badge size="sm" variant="outline" colorPalette="green">{item.from}</Badge>
                        <styled.span color="fg.muted">→</styled.span>
                        <Badge size="sm" variant="outline" colorPalette="green">{item.to}</Badge>
                      </HStack>
